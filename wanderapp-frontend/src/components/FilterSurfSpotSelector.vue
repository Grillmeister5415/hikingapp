<template>
  <div class="filter-surfspot-selector">
...
const props = defineProps({
  ...
  placeholder: {
    type: String,
    default: 'e.g. Pipeline, Mavericks'
  }
});
...
const searchSurfSpots = async (query) => {
  ...
  try {
    ...
    console.error('[FilterSurfSpotSelector] Error searching surf spots:', error);
    searchResults.value = [];
  } finally {
